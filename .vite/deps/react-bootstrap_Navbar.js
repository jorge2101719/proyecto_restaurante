...
import {
  require_prop_types
} from "./chunk-BNSZRLIE.js";
import {
  require_classnames,
  require_jsx_runtime,
  useBootstrapPrefix
} from "./chunk-ZNGFFKJJ.js";
import {
  __commonJS,
  __toESM,
  require_react
...
var NavbarCollapse = React9.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context2 = (0, import_react8.useContext)(NavbarContext_default);
...
var NavbarToggle = React10.forwardRef(({
  bsPrefix,
  className,
  children,
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react13.useState)(() => mql ? mql.matches : false);
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react14.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Context = (0, import_react19.createContext)(canUseDOM_default ? window : void 0);
...
function useTransition({
  ...
  const isInitialRef = (0, import_react22.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react22.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react22.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react23.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react23.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react23.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react23.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react23.useState)(!show);
  const lastFocusRef = (0, import_react23.useRef)(null);
  (0, import_react23.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react23.useRef)();
  const removeKeydownListenerRef = (0, import_react23.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime7.jsx)("div", Object.assign({}, dialogProps, {
    children: React12.cloneElement(children, {
      role: "document"
    })
  }));
...
var OffcanvasBody = React14.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasToggling = React15.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
...
var AbstractModalHeader = React18.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  const context2 = (0, import_react25.useContext)(ModalContext_default);
...
var OffcanvasHeader = React19.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var divWithClassName_default = (className) => React20.forwardRef((p, ref) => (0, import_jsx_runtime17.jsx)("div", {
  ...p,
  ref,
...
var OffcanvasTitle = React21.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React22.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const [showOffcanvas, setShowOffcanvas] = (0, import_react26.useState)(false);
  ...
  const renderBackdrop = (0, import_react26.useCallback)((backdropProps) => (0, import_jsx_runtime19.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React23.forwardRef((props, ref) => {
  const context2 = (0, import_react27.useContext)(NavbarContext_default);
...
var NavbarText = React24.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React25.forwardRef((props, ref) => {
  const {
